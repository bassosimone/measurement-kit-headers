...
Here we describe the sequence of operations performed when running a measurement-kit test, the options that you can use (via `set_option()`) to control the behavior, and the callbacks that will be called. 
